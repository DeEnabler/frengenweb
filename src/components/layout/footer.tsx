...
import { BotIcon, Twitter, Linkedin, Github } from 'lucide-react';
    ...
    <footer className="border-t border-border/40 bg-card text-card-foreground">
      <div className="container mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <Link href="/" className="flex items-center space-x-2 mb-4">
              ...
              <span className="font-headline text-xl font-bold text-primary">Missile OS</span>
            </Link>
            <p className="text-sm text-muted-foreground">
              AI-powered website building and maintenance for small businesses worldwide. Fast, affordable, professional.
            </p>
          </div>
          <div>
        ...
        <div className="mt-8 pt-4 border-t border-border/40 text-center">
          <p className="text-sm text-muted-foreground">
            &copy; {currentYear} Missile OS. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
